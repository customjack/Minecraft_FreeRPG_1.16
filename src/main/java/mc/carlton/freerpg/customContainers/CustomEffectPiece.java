...
public class CustomEffectPiece extends CustomContainer {
     ...
     * @param relativeDurationMultiplier multiplier for the duration of a relative effect, determines the duration in conjunction with relativeDurationAdded
     */
    ...
    /**
     * Sets the relative effect as the CustomEffectPiece with the longest duration in the CustomEffect relativeEffect
