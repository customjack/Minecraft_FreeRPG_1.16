...
public class CustomRecipe {
    ...
    public CustomRecipe(CustomRecipeCraftingGrid initialRecipe, ItemStack outputItem, int xpCost, String keyBase) {
    ...
    public CustomRecipe(CustomRecipeCraftingGrid initialRecipe, ItemStack outputItem, String keyBase) {
    ...
    public CustomRecipe(ArrayList<Material> recipe, ItemStack outputItem, int xpCost, String keyBase) {
    ...
    private HashSet<CustomRecipeCraftingGrid> getTranslatedVariants(CustomRecipeCraftingGrid initialRecipe) {
        return getTranslatedVariants(initialRecipe.getRecipe());
    }

    private HashSet<CustomRecipeCraftingGrid> getTranslatedVariants(ArrayList<Material> initialRecipe) {
    ...
    private ArrayList<Material> getTransformedRecipe(ArrayList<Material> initialRecipe,ArrayList<Integer> newIndices) {
        ArrayList<Integer> indices = getOccupiedIndicesInRecipe(initialRecipe);
