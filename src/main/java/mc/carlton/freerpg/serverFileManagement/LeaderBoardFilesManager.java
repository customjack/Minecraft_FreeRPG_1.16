...
public class LeaderBoardFilesManager {
    ...
    public void readInLeaderBoardFile() {
        ...
        for (String skillName : leaderboardsConfig.getKeys(false)) {
            for (String playerRank : leaderboardsConfig.getConfigurationSection(skillName).getKeys(false)) {
    ...
    public void deleteAbsentPlayersFromFile() { //This is likely best run aysnc
        ...
        createLeaderBoardFile(true); //We just recreate the file, it will only include players in the directory
    }
    ...
    public void addPlayerSkillStatsToLeaderBoard(YamlConfiguration leaderBoardYAML,String skillName, int position,ArrayList<PlayerLeaderboardStat> leaderboard){
    ...
    public void addPlayerSkillStatsToLeaderBoardGlobal(YamlConfiguration leaderBoardYAML, int position,ArrayList<PlayerLeaderboardStat> leaderboard){
        PlayerLeaderboardStat player = leaderboard.get(position);
        UUID playerUUID = player.get_playerUUID();
        String playerName = player.get_pName();
    ...
    public void addPlayerSkillStatsToLeaderBoardTime(YamlConfiguration leaderBoardYAML, int position,ArrayList<PlayerLeaderboardStat> leaderboard){
        PlayerLeaderboardStat player = leaderboard.get(position);
        UUID playerUUID = player.get_playerUUID();
        String playerName = player.get_pName();
