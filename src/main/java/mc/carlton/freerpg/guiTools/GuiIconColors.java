...
public class GuiIconColors {
     ...
     */
    public GuiIconColors(String nameColor, String descriptionColor, String statisticNameColor, String statisticColor) {
    ...
    /**
     * Default constructor for ThemeColors
     * Sets:
     * nameColor <- Bold and white
     * descriptionColor <- Gray and italic
