...
public class GuiDisplayStatistic {
     ...
     * @param statisticNameColor color of the statistic name (ex. ChatColor.BOLD + ChatColor.WHITE.toString())
     * @param statisticColor color of the statistic (ex. ChatColor.ITALIC + ChatColor.GRAY.toString())
     */
    public GuiDisplayStatistic(String statisticName, Object statistic,String statisticNameColor, String statisticColor) {
