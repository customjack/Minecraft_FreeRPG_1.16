...
public class UtilityMethods {
  ...
  public static boolean stringCollectionContainsIgnoreCase(Collection<String> colection,
      String inputString) {
  ...
  public static <E> boolean collectionOnlyContainsOneClass(Collection<? extends E> collection,
      Class<?> tClass) {
  ...
  public static boolean stringContainsIgnoreCase(String string,
      Collection<String> containedStringOptions) {
