...
public class LanguageSelector {
    ...
    /**
     * Translates a string into the player's preffered language assuming pieces identified by $:translateable;$ are a id
     *
    ...
    public static String getString(String id,String languageCode) { //Used if we want to ignore the player's language choice
        String text = "";
        StringsAndOtherData stringsAndOtherData = new StringsAndOtherData();
