...
public class PlayerLeaderboardStat {
    ...
    public PlayerLeaderboardStat(UUID playerUUID, String pName, int experience) { //By default, levelSupplied = false
        super();
    ...
    public PlayerLeaderboardStat(UUID playerUUID, String pName, Number sortedStat, Object stat2) { //Used for global stats
        super();
        this.playerUUID = playerUUID;
        this.pName = pName;
    ...
    public PlayerLeaderboardStat(UUID playerUUID, String pName, Number sortedStat) { //By default, levelSupplied = false
        super();
        this.playerUUID = playerUUID;
        this.pName = pName;
        this.sortedStat = sortedStat;
    ...
    public void set_playerUUID(UUID playerUUID) {this.playerUUID = playerUUID;}
    public void set_sortedStat(Number sortedStat){this.sortedStat = sortedStat;}
    public void set_stat2(Object stat2){this.stat2 = stat2;}
    public String get_pName() {
        return this.pName;
    }
    public UUID get_playerUUID() {return this.playerUUID;}
    public Number get_sortedStat(){return this.sortedStat;}
    public Object get_stat2(){return this.stat2; }
    ...
    public String toString() {
        return "PlayerLeaderboardStats [username="+pName+", sortedStat="+sortedStat+", stat2="+stat2+"]";
    }
