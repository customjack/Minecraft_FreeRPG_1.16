...
public class ItemGroups {
  ...
  public void initializeTrackedBlocks() {
    Material[] trackedBlocks0 = new Material[]{Material.ACACIA_LOG, Material.ACACIA_LEAVES,
        Material.BIRCH_LOG, Material.BIRCH_LEAVES,
        Material.DARK_OAK_LOG, Material.DARK_OAK_LEAVES, Material.JUNGLE_LOG,
        ...
        Material.SUGAR_CANE, Material.MELON, Material.PUMPKIN, Material.RED_MUSHROOM,
    ...
    if (mcVersion >= 1.16) {
      Material[] trackedBlocks_v1_16 = {Material.ANCIENT_DEBRIS, Material.NETHER_GOLD_ORE,
    ...
    if (mcVersion >= 1.17) {
      Material[] trackedBlocks_v1_17 = {Material.DEEPSLATE_COAL_ORE, Material.DEEPSLATE_DIAMOND_ORE,
          Material.DEEPSLATE_COPPER_ORE, Material.DEEPSLATE_EMERALD_ORE,
          Material.DEEPSLATE_IRON_ORE,
          Material.DEEPSLATE_GOLD_ORE, Material.DEEPSLATE_LAPIS_ORE,
  ...
  public void initializeBlocks() {
    Material[] tallCrops0 = {Material.SUGAR_CANE, Material.BAMBOO, Material.CACTUS, Material.KELP,
        Material.KELP_PLANT};
    tallCrops = Arrays.asList(tallCrops0);
    Material[] logs0 = {Material.ACACIA_LOG, Material.BIRCH_LOG, Material.DARK_OAK_LOG,
        Material.OAK_LOG,
        Material.SPRUCE_LOG, Material.JUNGLE_LOG, Material.STRIPPED_ACACIA_LOG,
    ...
    if (mcVersion >= 1.16) {
      Material[] logs_append0 = {Material.CRIMSON_STEM, Material.WARPED_STEM,
    ...
    Material[] crops0 = {Material.WHEAT, Material.BEETROOTS, Material.CARROTS,
        Material.CHORUS_FLOWER,
        Material.MELON_STEM, Material.MELON, Material.NETHER_WART, Material.POTATOES,
    ...
    // adds ore to list
    Material[] ores0 = {Material.REDSTONE_ORE, Material.NETHER_QUARTZ_ORE, Material.LAPIS_ORE,
        Material.IRON_ORE,
    ...
    if (mcVersion >= 1.16) {
      Material[] ores_append_v1_16 = {Material.NETHER_GOLD_ORE, Material.ANCIENT_DEBRIS,
    ...
    Material[] strippedLogs0 = {Material.STRIPPED_SPRUCE_LOG, Material.STRIPPED_OAK_LOG,
    ...
    Material[] wood0 = {Material.SPRUCE_WOOD, Material.OAK_WOOD, Material.JUNGLE_WOOD,
        Material.DARK_OAK_WOOD,
        Material.BIRCH_WOOD, Material.ACACIA_WOOD};
    wood = Arrays.asList(wood0);
    Material[] strippedWood0 = {Material.STRIPPED_SPRUCE_WOOD, Material.STRIPPED_OAK_WOOD,
        Material.STRIPPED_JUNGLE_WOOD,
        Material.STRIPPED_DARK_OAK_WOOD, Material.STRIPPED_BIRCH_WOOD,
    ...
    Material[] leaves0 = {Material.ACACIA_LEAVES, Material.BIRCH_LEAVES, Material.DARK_OAK_LEAVES,
        Material.OAK_LEAVES,
  ...
  public void initializeHarmfulPotions() {
    PotionEffectType[] harmfulEffects0 = {PotionEffectType.WEAKNESS, PotionEffectType.POISON,
        PotionEffectType.BLINDNESS, PotionEffectType.HUNGER,
        PotionEffectType.HARM, PotionEffectType.SLOW_DIGGING, PotionEffectType.SLOW,
  ...
  public void initializeActionItems() {
    Material[] noRightClick0 = {Material.AIR, Material.ARROW, Material.SPECTRAL_ARROW,
        Material.TIPPED_ARROW, Material.BLAZE_POWDER,
        Material.BLAZE_ROD, Material.BONE, Material.BOOK, Material.BOWL, Material.CHARCOAL,
        Material.COAL, Material.CLAY, Material.BRICK, Material.COMPASS,
        Material.DIAMOND_HORSE_ARMOR, Material.DRAGON_BREATH,
        Material.MAP, Material.ENCHANTED_BOOK, Material.FEATHER, Material.FERMENTED_SPIDER_EYE,
        Material.FIREWORK_STAR,
        Material.FLINT, Material.GHAST_TEAR, Material.GLISTERING_MELON_SLICE,
        Material.GLOWSTONE_DUST, Material.GOLDEN_HORSE_ARMOR,
        Material.GOLD_NUGGET, Material.GOLD_INGOT, Material.GUNPOWDER, Material.INK_SAC,
        Material.IRON_HORSE_ARMOR,
        Material.MAGMA_CREAM, Material.NETHER_BRICK, Material.NETHER_WART, Material.PAPER,
        Material.PRISMARINE_SHARD, Material.PRISMARINE_CRYSTALS,
        Material.RABBIT_HIDE, Material.LEATHER, Material.LEATHER_HORSE_ARMOR, Material.RABBIT_FOOT,
        Material.SADDLE, Material.SHEARS,
        Material.SLIME_BALL, Material.SHULKER_SHELL, Material.SPIDER_EYE, Material.STICK,
        Material.STRING, Material.TOTEM_OF_UNDYING,
        Material.CLOCK, Material.WRITTEN_BOOK};
    noRightClick = Arrays.asList(noRightClick0);
    Material[] actionableBlocks0 = {Material.ANVIL, Material.BLACK_BED, Material.BLUE_BED,
        ...
        Material.BELL, Material.BLAST_FURNACE, Material.BREWING_STAND, Material.CARTOGRAPHY_TABLE,
        Material.CHEST, Material.COMPOSTER,
        Material.CRAFTING_TABLE, Material.ACACIA_DOOR, Material.BIRCH_DOOR, Material.DARK_OAK_DOOR,
        Material.IRON_DOOR, Material.JUNGLE_DOOR,
        Material.OAK_DOOR, Material.SPRUCE_DOOR, Material.ENCHANTING_TABLE,
        Material.ACACIA_FENCE_GATE, Material.BIRCH_FENCE_GATE,
        Material.DARK_OAK_FENCE_GATE, Material.JUNGLE_FENCE_GATE, Material.OAK_FENCE_GATE,
        Material.SPRUCE_FENCE_GATE, Material.FURNACE,
        Material.GRINDSTONE, Material.JUKEBOX, Material.LECTERN, Material.LOOM, Material.NOTE_BLOCK,
        Material.SMOKER, Material.STONECUTTER,
        Material.TRAPPED_CHEST, Material.ACACIA_TRAPDOOR, Material.BIRCH_TRAPDOOR,
        Material.DARK_OAK_TRAPDOOR, Material.IRON_TRAPDOOR,
        Material.JUNGLE_TRAPDOOR, Material.OAK_TRAPDOOR, Material.SPRUCE_TRAPDOOR, Material.BARREL,
        Material.ACACIA_BUTTON, Material.BIRCH_BUTTON,
        Material.DARK_OAK_BUTTON, Material.OAK_BUTTON, Material.JUNGLE_BUTTON,
        Material.SPRUCE_BUTTON, Material.STONE_BUTTON, Material.REPEATER,
        Material.COMPARATOR, Material.HOPPER, Material.HOPPER_MINECART, Material.DAYLIGHT_DETECTOR,
        Material.LEVER, Material.FURNACE_MINECART,
        Material.DISPENSER, Material.DROPPER, Material.CHIPPED_ANVIL, Material.DAMAGED_ANVIL,
        Material.SHULKER_BOX, Material.ENDER_CHEST, Material.BLACK_SHULKER_BOX,
  ...
  public void initializeTools() {
    Material[] pickaxes0 = {Material.DIAMOND_PICKAXE, Material.GOLDEN_PICKAXE,
        Material.IRON_PICKAXE, Material.STONE_PICKAXE, Material.WOODEN_PICKAXE};
    pickaxes = new LinkedList<>(Arrays.asList(pickaxes0));
    Material[] axes0 = {Material.DIAMOND_AXE, Material.GOLDEN_AXE, Material.IRON_AXE,
        Material.STONE_AXE, Material.WOODEN_AXE};
    axes = new LinkedList<>(Arrays.asList(axes0));
    Material[] shovels0 = {Material.DIAMOND_SHOVEL, Material.GOLDEN_SHOVEL, Material.IRON_SHOVEL,
        Material.STONE_SHOVEL, Material.WOODEN_SHOVEL};
    shovels = new LinkedList<>(Arrays.asList(shovels0));
    Material[] hoes0 = {Material.DIAMOND_HOE, Material.GOLDEN_HOE, Material.IRON_HOE,
        Material.STONE_HOE, Material.WOODEN_HOE};
    hoes = new LinkedList<>(Arrays.asList(hoes0));
    Material[] swords0 = {Material.WOODEN_SWORD, Material.STONE_SWORD, Material.GOLDEN_SWORD,
  ...
  public void initializeLeftClickItems() {
    Material[] leftClickItems0 = {Material.IRON_SWORD, Material.DIAMOND_SWORD,
        Material.GOLDEN_SWORD, Material.STONE_SWORD, Material.WOODEN_SWORD,
        Material.IRON_PICKAXE, Material.DIAMOND_PICKAXE, Material.STONE_PICKAXE,
        Material.GOLDEN_PICKAXE, Material.WOODEN_PICKAXE,
        Material.IRON_SHOVEL, Material.DIAMOND_SHOVEL, Material.GOLDEN_SHOVEL,
        Material.STONE_SHOVEL, Material.WOODEN_SHOVEL,
        Material.IRON_AXE, Material.DIAMOND_AXE, Material.GOLDEN_AXE, Material.STONE_AXE,
        Material.WOODEN_AXE,
        Material.BOW, Material.CROSSBOW};
    leftClickItems = new LinkedList<>(Arrays.asList(leftClickItems0));
    if (mcVersion >= 1.16) {
      Material[] leftClickItems_append0 = {Material.NETHERITE_SWORD, Material.NETHERITE_SHOVEL,
  ...
  public void initializeIngredients() {
    ...
    Material[] newIngredients0 = {alchemyInfo.get("customPotion1").getIngredient(),
        alchemyInfo.get("customPotion2").getIngredient(),
        alchemyInfo.get("customPotion3").getIngredient(),
        alchemyInfo.get("customPotion4").getIngredient(),
        alchemyInfo.get("customPotion5").getIngredient()};
    newIngredients = Arrays.asList(newIngredients0);
    Material[] oldIngredients0 = {Material.NETHER_WART, Material.GUNPOWDER, Material.GLOWSTONE_DUST,
        Material.SPIDER_EYE, Material.GHAST_TEAR,
        Material.RABBIT_FOOT, Material.BLAZE_POWDER, Material.GLISTERING_MELON_SLICE,
        Material.SUGAR, Material.MAGMA_CREAM,
        Material.REDSTONE, Material.PUFFERFISH, Material.GOLDEN_CARROT, Material.TURTLE_HELMET,
  ...
  public void initializeValuableItems() {
    Material[] valuableItems0 = {Material.IRON_ORE, Material.GOLD_ORE, Material.DIAMOND_ORE,
        Material.EMERALD_ORE, Material.REDSTONE_ORE, Material.LAPIS_ORE,
        ...
        Material.NETHER_WART_BLOCK, Material.DRAGON_EGG, Material.SHULKER_BOX,
        Material.ENCHANTING_TABLE, Material.ANVIL, Material.BEACON, Material.BREWING_STAND,
        Material.CAKE, Material.JUKEBOX,
        Material.TNT, Material.CREEPER_HEAD, Material.DRAGON_HEAD, Material.PLAYER_HEAD,
        Material.ZOMBIE_HEAD, Material.SKELETON_SKULL, Material.WITHER_SKELETON_SKULL,
        Material.ENDER_EYE, Material.ENDER_PEARL, Material.FIREWORK_ROCKET, Material.FIRE_CHARGE,
        Material.POTION, Material.SPLASH_POTION, Material.LINGERING_POTION,
        Material.NETHER_WART, Material.REDSTONE, Material.TRIDENT, Material.DIAMOND_AXE,
        ...
        Material.ELYTRA, Material.ENCHANTED_BOOK, Material.ENCHANTED_GOLDEN_APPLE,
        Material.GOLDEN_APPLE, Material.IRON_INGOT,
        ...
        Material.NAME_TAG, Material.TIPPED_ARROW, Material.TOTEM_OF_UNDYING,
        Material.SPECTRAL_ARROW, Material.DIAMOND, Material.GOLD_INGOT,
        Material.HEART_OF_THE_SEA, Material.DRAGON_BREATH, Material.EMERALD,
        Material.NAUTILUS_SHELL, Material.NETHER_STAR, Material.SLIME_BALL,
        Material.RABBIT_FOOT};
    valuableItems = new LinkedList<>(Arrays.asList(valuableItems0));
    if (mcVersion >= 1.16) {
      Material[] valuableItems_append0 = {Material.NETHERITE_SWORD, Material.NETHERITE_HOE,
          Material.NETHERITE_SHOVEL, Material.NETHERITE_AXE, Material.NETHERITE_PICKAXE,
          Material.NETHER_GOLD_ORE,
          Material.NETHERITE_BLOCK, Material.NETHERITE_BOOTS, Material.NETHERITE_CHESTPLATE,
          Material.NETHERITE_HELMET, Material.NETHERITE_INGOT, Material.NETHERITE_LEGGINGS,
  ...
  public void initalizeArrows() {
    PotionType[] potionType = {PotionType.WATER, PotionType.MUNDANE, PotionType.THICK,
        PotionType.AWKWARD, PotionType.NIGHT_VISION,
        PotionType.INVISIBILITY, PotionType.JUMP, PotionType.FIRE_RESISTANCE, PotionType.SPEED,
        PotionType.SLOWNESS,
        PotionType.WATER_BREATHING, PotionType.INSTANT_HEAL, PotionType.INSTANT_DAMAGE,
        PotionType.POISON,
        PotionType.REGEN, PotionType.STRENGTH, PotionType.WEAKNESS, PotionType.LUCK,
        PotionType.TURTLE_MASTER, PotionType.SLOW_FALLING};
    String[] labels = {"water", "mundane", "thick", "awkward", "night_vision", "invisibility",
        "leaping", "fire_resistance", "swiftness", "slowness",
        "breathing_water", "healing", "harming", "poison", "regeneration", "strength", "weakness",
        "luck", "turtle_master", "slow_falling"};
